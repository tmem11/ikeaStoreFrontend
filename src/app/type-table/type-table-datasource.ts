...
const EXAMPLE_DATA: TypeTableItem[] = [
...
export class TypeTableDataSource extends DataSource<TypeTableItem> {
  data: TypeTableItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: TypeTableItem[]): TypeTableItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TypeTableItem[]): TypeTableItem[] {
